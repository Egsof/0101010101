...
function setHumanMode() {
    ...
    if(playMode != "h") {
        ...
        alert("Anda sudah memainkan Manusia vs Manusia");
    }
}
...
function setComputerMode() {
    ...
    if(playMode != "c") {
        ...
        alert("Anda sudah memainkan Manusia vs Komputer");
    }
}
...
function changeTurn() {
    ...
    if(whitesTurn) {
        ...
        // change to Giliran Hitam
        whitesTurn = false;
        em.innerHTML = "Giliran Hitam";

        moveAmount =  getAllPossibleMovesOfPlayer("b", board).length;
        
    } else {
        whitesTurn = true;
        em.innerHTML = "Giliran Putih"
    ...
    if(moveAmount === 0) {
        ...
        if(whitesTurn && checkIfPlayerIsInChess("w", board)) {
            moveCounter.innerHTML = "Hitam Menang! 👏";

        } else if (!whitesTurn && checkIfPlayerIsInChess("b", board)) {
            moveCounter.innerHTML = "Putih Menang! 👏";
        } else {
            moveCounter.innerHTML = "Pertandingan Seri.";
        }

    } else {
        moveCounter.innerHTML = "Prediksi: " + moveAmount;
    }
}
